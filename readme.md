...
This project intentionally avoids external dependency managers like Composer. All third-party libraries (such as `php-jwt`) and internal classes are loaded manually via `require_once` statements in the `bootstrap.php` file. This approach keeps the setup simple and self-contained.
